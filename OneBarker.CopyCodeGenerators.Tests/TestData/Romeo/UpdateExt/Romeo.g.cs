...
partial class Romeo
{
    ...
    /// </summary>
    partial void BeforeUpdateExternal(OneBarker.CopyCodeGenerators.Samples.RomeoSource source, ref OneBarker.CopyCodeGenerators.Samples.RomeoTarget target, ref int changeCount);

    /// <summary>
    /// Method to run after the UpdateExternal method finishes copying values.
    /// </summary>
    partial void AfterUpdateExternal(OneBarker.CopyCodeGenerators.Samples.RomeoSource source, ref OneBarker.CopyCodeGenerators.Samples.RomeoTarget target, ref int changeCount);

    /// <summary>
    /// Updates properties from the source object to the target object and returns the number of changes.
    /// </summary>
    public new int UpdateExternal(OneBarker.CopyCodeGenerators.Samples.RomeoSource source, ref OneBarker.CopyCodeGenerators.Samples.RomeoTarget target)
    {
