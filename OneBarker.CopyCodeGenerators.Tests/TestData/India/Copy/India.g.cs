...
partial class India
{
    ...
    /// </summary>
    partial void BeforeCopyFrom(System.Numerics.Vector3 source);

    /// <summary>
    /// Method to run after the CopyFrom method finishes copying values.
    /// </summary>
    partial void AfterCopyFrom(System.Numerics.Vector3 source);

    /// <summary>
    /// Copies properties from the source object to this object and returns this object.
    /// </summary>
    public new India CopyFrom(System.Numerics.Vector3 source)
    {
    ...
    /// Method to run before the CopyFrom method begins copying values.
    /// </summary>
    partial void BeforeCopyFrom(India source);

    /// <summary>
    /// Method to run after the CopyFrom method finishes copying values.
    /// </summary>
    partial void AfterCopyFrom(India source);

    /// <summary>
    /// Copies properties from the source object to this object and returns this object.
    /// </summary>
    public new India CopyFrom(India source)
    {
        if (ReferenceEquals(null, source)) throw new ArgumentNullException();
        if (ReferenceEquals(this, source)) return this;
        BeforeCopyFrom(source);
